...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../estilos/interno/funcao/edicao.css" />    
    <script type="application/javascript" src="../../../scripts/interno/funcao/edicao.js"></script>
    <meta charset="utf-8" />
...
<body>
    ...
    <section>
        ...
        <?php if (isset($_GET['alterado'])){ ?>
            <p style="color: green;">Função alterada com sucesso</p>
        <?php } ?>
        <form name="form_edicao_funcao" method="post" action="../../../servicos/operacao/funcao/edicao.php">
            <?php 
                $funcao = (new Funcao($id, null, null))->consultarPorID()['funcao'];                                                           
            ?>
            <div>
                <label for="id">ID</label>
                <input id="id" name="id" type="text" readonly value="<?php print $funcao->getId(); ?>"/>
            </div>
            <div>
                <label for="nome">Nome</label>
                <input id="nome" name="nome" type="text" value="<?php print $funcao->getNome(); ?>"/>
            </div>
            <div>
