...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../estilos/interno/equipamento/cadastro.css" />
    <script type="application/javascript" src="../../../scripts/interno/equipamento/cadastro.js"></script>
    <meta charset="utf-8" />
...
<body>
    ...
    <section>
        ...
        ?>
        <form name="form_cadastro_equipamento" method="post">
            <!-- Nome -->
            <div>
            ...
            <div>
                <!-- Confirmar -->
                <input class="inline-block" type="submit" name="confirmar" value="Confirmar" formaction="../../../servicos/operacao/equipamento/cadastro.php" />
