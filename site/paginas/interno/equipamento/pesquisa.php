...
$urlCadastro = Request::PREFIXO_URL . "{$_SERVER['SERVER_NAME']}/estagio/site/paginas/interno/equipamento/cadastro.php";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../estilos/interno/equipamento/pesquisa.css" />
    <script type="application/javascript" src="../../../scripts/interno/equipamento/pesquisa.js"></script>
    <meta charset="utf-8" />
    <title>CallSYS - Equipamentos</title>
</head>
        ...
        <div id="equipamentos">
            <table>
                <tbody>
                    ...
                    <?php require_once "../../../servicos/operacao/equipamento/pesquisa.php" ?>
                </tbody>
            </table>
        </div>
    </section>
