        ...
        <section>
            ...
            <form name="form_cadastro_usuario" action="" method="post">
                ...
                <div>
                    ...
                    <input class="inline-block" type="text" name="id_setor" placeholder="ID do setor" disabled/>
                    <input class="inline-block" type="text" name="nome_setor" placeholder="Nome do setor" required/>
                ...
                <div>
                    ...
                    <input class="inline-block" type="text" name="id_funcao" placeholder="ID da função" disabled/>
                    <input class="inline-block" type="text" name="nome_funcao" placeholder="Nome da função" required/>
                ...
                <div>
                    ...
                    <input class="inline-block" type="text" name="id_nivel_acesso" placeholder="ID do nível de acesso" disabled/>
                    <input class="inline-block" type="text" name="nome_nivel_acesso" placeholder="Nome do nível de acesso" required/>
