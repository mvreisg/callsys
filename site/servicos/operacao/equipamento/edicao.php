...
$url = Request::PREFIXO_URL . "{$_SERVER['SERVER_NAME']}/estagio/site/paginas/interno/equipamento/edicao.php?";
...
if ($ok){
    ...
    $equipamento = new Equipamento($id, $nome, $ativo, null);
    $resultado = $equipamento->alterarPorId();    
