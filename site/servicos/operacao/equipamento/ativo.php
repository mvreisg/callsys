...
$urlRedirecionamento = Request::PREFIXO_URL . "{$_SERVER['SERVER_NAME']}/estagio/site/paginas/interno/equipamento/pesquisa.php?";

$dadosValidos = true;

// Checa se o GET de id_equipamento foi recebido
if (!isset($_GET['id_equipamento'])) {
    $dadosValidos = false;
    $urlRedirecionamento .= "id_equipamento_informado=0&";
}
...
if ($dadosValidos) {
    ...
    $resultado = (new Equipamento($idEquipamento, null, $novoAtivo, null))->alterarAtivo();
